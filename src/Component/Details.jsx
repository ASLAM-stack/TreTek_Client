  ...
  return (
    <div>
      <div className="section-title text-center mt-10 mb-12">
        ...
        <h2 className="text-4xl font-bold">{spot.tourists_spot_name}</h2>
      </div>
      <div>
        <div className="w-full p-4 bg-[#e6e4e42f] rounded-xl mb-4">
            <img className="h-[500px] rounded-xl" src={spot.image} alt="" />
        </div>
        <div className="w-full p-4 bg-[#e6e4e42f] rounded-xl mb-4">
            <h1 className="text-3xl font-medium mb-2">Average Cost:&nbsp;{spot.average_cost}<span>$</span></h1>
            <div className="flex gap-2 flex-wrap">
                <div className="flex items-center gap-2">
                <FaClockRotateLeft className="text-[#63AB45] text-xl"/>
                <span className="text-base font-semibold">{spot.travel_time}</span>
                </div>
                <div className="flex items-center gap-2">
                <FaMapLocation className="text-[#63AB45] text-xl"/>
                <span className="text-base font-semibold">{spot.location}</span>
                </div>
                <div className="flex items-center gap-2">
                <MdTravelExplore className="text-[#63AB45] text-xl"/>
                <span className="text-base font-semibold">{spot.totalVisitors_PerYear}</span>
                </div>
                <div className="flex items-center gap-2">
                <BiCableCar className="text-[#63AB45] text-xl"/>
                <span className="text-base font-semibold">{spot.seasonality}</span>
                </div>
            </div>
            <div className="mt-4">
